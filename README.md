...
- Membuat aplikasi berbasis terminal (CLI) menggunakan Bahasa C  
- Menyelesaikan satu masalah nyata yang diidentifikasi melalui observasi.  
- Dikerjakan secara berkelompok.  

## Tugas Utama
1. **Stock Management**  
   - Menambahkan, menghapus, dan mengupdate stok buah.  
   - Menampilkan daftar stok tersedia.  

2. **Transaction System**  
   - Membuat transaksi penjualan.  
   - Menghitung total harga dan mencatat riwayat transaksi.  
